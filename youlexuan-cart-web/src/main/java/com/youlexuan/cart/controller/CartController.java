...
public class CartController {
    ...
    /**
     * 1、未登录  从cookie中取老购物车列表，计算出新购物车列表以后，再将新的购物车列表写到cookie中
     * 2、已登录  从redis中取购物车列表，计算出新的购物车列表以后，再将新列表写到redis中
     * @param itemId
     * @param num
     * @return
     */
    ...
    public Result addCart(Long itemId, Integer num){
        ...
        try {
            ...
            //如果没有登录那么将新购物车列表写给浏览器的cookie，如果登录了，那么将新的carlist放到redis中
